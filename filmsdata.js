...
function initFilm(filmId, datesId, timeId, periodId) {
    const datesDiv      = document.getElementById(datesId);
    ...
    function createdate() {
        for (let date in filmsData[filmId]) {
            ...
            dateButton.onclick = function () {
                datesDiv.querySelectorAll('.date-btn').forEach(btn => {
    ...
    function showtime(selectedDate) {
        ...
        const times = filmsData[filmId][selectedDate];
        ...
        for (let time of times) {
            ...
            timeButton.onclick = function () {
                timeContainer.querySelectorAll('.time-btn').forEach(btn => {
                    btn.style.backgroundColor = '';
                    btn.style.border = '';
                });
                this.style.backgroundColor = 'darkred';
